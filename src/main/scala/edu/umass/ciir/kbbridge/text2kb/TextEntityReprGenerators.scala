 ...
 * Time: 2:12 PM
 */
trait TextEntityReprGenerators {
...
object QTextEntityRepr extends TextEntityReprGenerators {
  def createEntityRepr(query: EntityMention) = {
    EntityRepr(entityName = query.entityName, queryId = Some(query.mentionId))
  }
}
object QVTextEntityRepr extends TextEntityReprGenerators {
...
object QVSTextEntityRepr extends TextEntityReprGenerators {
  import TextEntityReprGeneratorsUtil._
  def createEntityRepr(query: EntityMention) = {
    val nameVariants = createNameVariantsContext(query)
...
object QVSMLocalTextEntityRepr extends TextEntityReprGenerators {
  import TextEntityReprGeneratorsUtil._
  def createEntityRepr(query: EntityMention) = {
    val nameVariants = createNameVariantsContext(query)
...
object QVMLocalTextEntityRepr extends TextEntityReprGenerators {
  import TextEntityReprGeneratorsUtil._
  def createEntityRepr(query: EntityMention) = {
    val nameVariants = createNameVariantsContext(query)
    val neighborHood = convertNeighborNameToEntityRepr(createNeighborNameContext(query, nameVariants.map(_._1)))
